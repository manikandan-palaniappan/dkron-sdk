...
=============
    ...
    2. Open a command prompt and navigate to the JavaSDK/DkronRESTAPILib folder.
    ...
    4.In your own maven application, add the following lines which will refer to newly installed SDK: 
        <dependency>
            <groupId>DkronRESTAPILib</groupId>
            <artifactId>DkronRESTAPILib</artifactId>
...
Exporting JARs:
    ...
    3. Check the box beside "DkronRESTAPILib" and click on "Finish".
