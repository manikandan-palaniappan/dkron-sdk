...
public class ExecutionsController extends BaseController {    
    ...
    private static ExecutionsController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the ExecutionsController class 
     */
    public static ExecutionsController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new ExecutionsController();
            }
        }
        return instance;
    }
